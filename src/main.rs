...
use crate::components::{
    BlocksTile, CombatStats, InBackpack, Item, Monster, MovementSpeed, Name, Player, Position,
    Potion, Renderable, SufferDamage, Viewshed, WantsToMelee, WantsToPickupItem,
};
...
impl Default for Client {
    fn default() -> Self {
        Client {
            ...
            keys: hashmap![VirtualKeyCode::E => KeyPress::new(100, 500), VirtualKeyCode::I => KeyPress::new(100, 500), VirtualKeyCode::Escape => KeyPress::new(100, 100)],
        }
    }
}
